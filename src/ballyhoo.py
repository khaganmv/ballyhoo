...
class Ballyhoo(ctk.CTk):
    def __init__(self):
        ...
        self.show_completed_switch = ctk.CTkSwitch(master=self, text='Show Completed')
        self.dark_mode_switch = DarkModeSwitch(master=self, text='Dark Mode')
        ...
        self.input_field.grid(row=2, column=0, columnspan=2, padx=25, pady=(10, 20), sticky='ew')
